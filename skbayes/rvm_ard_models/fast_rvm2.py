...
class RegressionARD2(LinearModel,RegressorMixin):
    '''
...
class ClassificationARD2(BaseEstimator,LinearClassifierMixin):
    '''
...
class RVR2(RegressionARD2):
    ...
    def __init__(self, n_iter=300, tol = 1e-3, fit_intercept = INTERCEPT, copy_X = True,
        ...
        super(RVR2,self).__init__(n_iter,tol,fit_intercept,copy_X,verbose)
        self.kernel = kernel
        self.degree = degree
        self.gamma  = gamma
        self.coef0  = coef0
